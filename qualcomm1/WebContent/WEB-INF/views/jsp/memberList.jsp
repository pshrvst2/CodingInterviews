...
<spring:url value="/resources/core/js/memberlist.js" var="memberlistJs" />
<script src="${memberlistJs}"></script>

</head>

<body ng-controller="memberlistCtrl">
		...
		<div class="site-wrapper-inner">
			<div class="cover-container">
               ...
               <div>
				...
				<input  id="inputDesc"  class="form-control" ng-model="inputDesc" placeholder="Description" required=""> 
				<br /> 
               </div>
				<div>
					<button class="btn btn-lg btn-primary btn-block" type="submit" ng-click= "updateDesc(inputName, inputDesc)">Update Description</button>
					<br /> 
					<button class="btn btn-lg btn-primary btn-block btn-danger" type="submit" ng-click= "deleteUser(inputName)">Delete User</button>
				</div>	
			</div>
